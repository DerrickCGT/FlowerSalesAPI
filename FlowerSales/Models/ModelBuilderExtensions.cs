    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(
                new Category { Id = 1, CategoryName = "Bouquetes" },
                new Category { Id = 2, CategoryName = "Box Flowers" },
                new Category { Id = 3, CategoryName = "Wrapps" },
                new Category { Id = 4, CategoryName = "Single Flower" },
                new Category { Id = 5, CategoryName = "Additional" });
